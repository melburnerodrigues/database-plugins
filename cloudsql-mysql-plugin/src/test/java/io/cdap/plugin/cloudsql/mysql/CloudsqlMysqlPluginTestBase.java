...
public class CloudsqlMysqlPluginTestBase extends DatabasePluginTestBase {
  ...
  protected static final String JDBC_DRIVER_NAME = "cloudsql-mysql";
  ...
  protected static final Map<String, String> BASE_PROPS =
      ImmutableMap.<String, String>builder()
          .put(
              ...
              System.getProperty(
                  "cloudsqlMysql.instance", "plucky-lane-250409:us-central1:test-plugin"))
          ...
          .put(ConnectionConfig.PASSWORD, System.getProperty("cloudsqlMysql.password", "mel@12"))
